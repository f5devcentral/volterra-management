...
def findUserEmail(ns: str, domain: str='f5.com') -> str:
    userEmail = ns.replace('-', '.') + '@' + domain
    return userEmail
...
def createUserNS(email: str, s: dict, desc: str ='automatically generated by tenant admin') -> dict:
    userNS = findUserNS(email)
...
def createUserRoles(email: str, first_name: str, last_name: str, s: dict, createdNS: str=None, exists: bool=False, role: str="default") -> dict:
    ...
    if createdNS:
        ...
        userPayload['namespace_roles'].append(
            {'namespace': createdNS, 'role': 'f5xc-aip-admin'})
    try:
        if exists:
